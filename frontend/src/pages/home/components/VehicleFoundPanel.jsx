...
const VehicleFoundPanel = () => {
  ...
  useEffect(() => {
    reciveMessage("ride-started", async (data) => {
        ...
        <div className="">
          <div>
            ...
            <div className="flex justify-between py-2">
              ...
              <div className="text-right text-[#545454] font-medium">
                ...
                <span>OTP: {userRideDetails.otp}</span>
              </div>
            </div>
          </div>
          ...
          <div
            className={`flex justify-center ${
              !rideStart ? "bg-yellow-400" : "bg-green-400"
            } rounded-2xl items-center m-1 p-3 border-b border-gray-200 mb-7 mt-2`}
          >
            ...
            <div className="w-full ">
              <h4 className="text-xl font-bold">
                {destLocation} {rideStart && "(Ride Started)"}
              </h4>
