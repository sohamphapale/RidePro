...
const CaptainSignup = () => {
  ...
  return (
    <div className="p-7 flex flex-col justify-between h-screen ">
      ...
      <div>
        <p className="text-[8px] leading-tight">This site is protected by reCAPTACHA and <span className="underline">Google Privacy Policy</span> and <span className="underline">  Terms of Service apply.</span></p>
      </div>
    </div>
  );
};
